...
```jsx
import { LoadingIndicator } from "base-ui/components/Indicator";
```
...
```jsx
import { CircularProgress } from "base-ui/components/Indicator";
```
...
```jsx
import { LoadingDots } from "base-ui/components/Indicator";
```
