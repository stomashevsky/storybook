...
Base UI is a lightweight, accessible design system for building high-quality applications. It provides Tailwind-integrated design tokens, a curated React component library, and utilities optimized for consistent user experiences.

## Features

- **Design tokens** for colors, typography, spacing, sizing, shadows, surfaces, and more.
- **Tailwind 4 integration** pre-configured with Base UI's design tokens.
...
Base UI requires **React 18 or 19** and **Tailwind 4**.
...
import { Calendar, Invoice, Maps, Members, Phone } from "base-ui/components/Icon"
